...
Working with cameras and post-production software—particularly for product photography (which I'd argue is very hard to do on a budget)—taught me an extraordinary amount about what it takes to make good digital content. Working with AI to do the same has been even more difficult.
