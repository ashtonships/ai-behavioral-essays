...
## Two Fundamental Approaches to AI

Before diving into specific applications, you need to understand the two fundamentally different ways to use AI in your work. Most advice conflates these, leading to confusion about when AI helps and when it produces generic output.

### Approach 1: Templates + AI Customization

Start with a proven template, framework, or existing structure. Use AI to fill gaps, customize copy, and adapt to specific situations.

**When to use it:**
- Standard deliverables with established patterns
- Time-sensitive work where "good enough" genuinely is
- Situations where consistency matters more than originality
- Volume work (dozens of similar outputs needed)

**How it works:**
- Select a template that fits the need
- Feed AI the template structure plus client-specific context
- AI generates customized content within the proven framework
- Review and adjust as needed

This approach is fast, predictable, and handles most routine business needs. AI functions as an *efficiency tool*—doing the same work faster.

### Approach 2: AI Exploration → Specification → Build

Use AI generations not as final output, but as *exploration material*. Generate multiple variations to understand the problem space, extract useful components and patterns, then formulate actual specifications and build properly.

**When to use it:**
- High-value work where generic output fails
- New problem types without established templates
- Situations requiring genuine differentiation
- Work where quality ceiling matters more than speed

**How it works:**
1. Generate multiple AI outputs on the topic (different angles, formats, approaches)
2. Analyze what's useful vs. what's generic across generations
3. Extract components, phrases, structures that work
4. Use insights to write specifications for what you actually need
5. Build the final deliverable—with AI assistance—but guided by your specs

This approach takes longer (weeks instead of hours for complex projects) but produces work that doesn't feel AI-generated. AI functions as a *research and ideation tool*—helping you understand the space before committing to an approach.

### Knowing Which to Use

The key question: **Does this need to be distinctive, or does it need to exist?**

A follow-up email to a lead? Template approach—it needs to be professional and timely, not revolutionary.

A core service page for a competitive market? Exploration approach—generic AI copy here means blending into the background noise.

Most local businesses benefit from using the template approach for 80% of their work (communication, routine content, administrative tasks) and the exploration approach for 20% (core marketing, key proposals, strategic content).

The workflows in this essay work with either approach. Where relevant, notes indicate which situations call for which.
...
Here's a workflow that works well for building local business sites—whether you're a developer building for clients or a business owner doing it yourself:

**Discovery (30 minutes).** Gather the essential information—through conversation or an intake form: What services do you offer? What areas do you serve? Who's your ideal customer? What makes you different? What questions do customers always ask?

**Content generation (1-2 hours).** Using the discovery notes as context, prompt AI to generate:
...
**Structure and design (2-3 hours).** Build the site using a template system (Webflow, Squarespace, WordPress, or a framework like Next.js all work). The AI-generated content slots into the structure.

**Photos & enhancement (30 minutes).** Authentic photos beat AI-generated. Gather real shots: team, completed work, equipment, storefront. Use AI as an *amplifier*—lighting, resolution, background cleanup—not a fabricator. Amplify the story you have.

Build a workflow that turns iPhone shots into $10k-photoshoot quality. Setup takes time; execution becomes 30 seconds to shoot, 2 minutes to enhance.

*Emerging:* AI that rates photos and generates variants optimized for specific platforms/audiences—not "make this viral" but deeper algorithmic targeting.

When stock photos are necessary, be explicit about which shots are illustrative.

**Review and refinement (1 hour).** Review the site and use AI to quickly revise copy based on feedback—tone adjustments, adding specific details, rephrasing unclear sections.
...
**Which approach?** For most local business sites, the template + AI customization approach works well—there's a proven structure, and AI helps fill it efficiently. For competitive markets or premium positioning, consider the exploration approach: generate multiple content variations, identify what feels generic versus distinctive, and build specifications before finalizing copy.
...
This prompt embeds "high-fidelity context" (see [[Maximizing AI Utility as a Business Owner]]). The more specific detail you provide about the business, the less the AI has to guess, and the better the output.

### Maintenance and Updates

AI reduces the friction of keeping sites current. When a client requests adding a new service area, updating service area pages takes minutes rather than becoming a billable project. This changes the economics of maintenance—more value delivered with less time invested.

For ongoing content needs, create a simple prompt library: "Use this prompt to generate a blog post about [seasonal topic]." This empowers consistent updates without starting from scratch each time.
...
A plumber serving a metropolitan area might want pages for the main city plus a dozen surrounding neighborhoods. Each page needs unique content to avoid duplicate content penalties while targeting "[service] in [area]" searches.
...
Business owners commonly go from ignoring 80% of reviews to responding to 100% once this workflow is in place.
...
A landscaper's mental notes: "Remove two trees, grade slope, install retaining wall, maybe 3 days work, need to rent equipment."
...
```
Analyze this inquiry for my web development business. We specialize in flat-rate website builds for local service businesses.
...
The math is simple: if AI saves you 5 hours/month, multiply by your hourly rate to get the value. A $20 tool that saves several times its cost each month is a clear win.

More realistically, here's what typical time savings look like:
...
A developer charging a reasonable fee to set up AI workflows might save you 20+ hours of figuring it out yourself. If that time is worth more than their fee, hiring makes better economic sense.

For more on the economics of AI investment, see [[Intelligence as a Commodity]].

---

## Part 9: Considerations for Service Providers

This section is for developers, marketers, and consultants offering AI-enhanced services to local businesses.
...
AI changes the time-to-value equation. Work that previously took 15 hours might take 6. This creates options:

- **Maintain pricing, improve margins.** Same deliverable quality and price, less time invested. Your effective rate increases.
- **Reduce pricing, increase volume.** Compete on price while maintaining quality. Viable for standardized offerings.
- **Expand scope, maintain pricing.** Include more in the same package—more pages, more content, more ongoing support.

The right choice depends on your market positioning and client base. There's no universal answer.
...
- Provide specific metrics when you have them
- Offer a small initial project before large commitments
- Make results tangible and verifiable

### Recurring Relationships

AI enables maintenance offerings that make sense for both parties: monthly SEO content, ongoing review management, quarterly website updates. These were often impractical to offer profitably before; AI changes that calculation.
...
- **Claude Pro or ChatGPT Plus ($20)** — Your core AI assistant. Pick one and master it. ChatGPT includes image generation (DALL-E 4); Claude excels at longer reasoning and writing.
- **Gmail/Outlook AI (Free)** — Email AI is now built-in. Gmail's Gemini features include Help Me Write, conversation summaries, and smart replies at no additional cost.
- **Canva Free** — Handles basic design needs. Upgrade to Pro only when you hit limits.

**Optimal Budget (~$40/month)**
- Everything above, plus:
- **Canva Pro (~$13/month)** — Full AI design suite: Magic Write, text-to-image, background removal, brand kits, 100M+ stock assets.
- **Otter.ai Pro (~$8/month annual)** — 1,200 minutes/month transcription. Useful for documenting processes and client calls.

**Extended Budget (~$70-90/month)**
- Everything above, plus one of:
- **AI phone answering (~$50/month)** — Services like IsOn24, BookingBee, or Goodcall answer calls 24/7, book appointments, capture leads. Replaces $400+/month answering services. *This is the biggest new category for local businesses.*
- **Professional booking (Acuity, ~$20/month)** — If you need client self-scheduling with payments and reminders.

### What NOT to Buy

- **Multiple AI assistants** — Pick Claude or ChatGPT, not both. They overlap 90%.
- **Specialized SEO tools** — Your general AI handles local SEO content. Dedicated SEO software is overkill until you're actively competing for rankings.
- **Expensive CRM add-ons** — Start with what's built into your existing tools.

*Note: Pricing as of January 2026. Verify current rates before committing.*
